...
# Instructions
Answer the problems located inside `prob01`, `prob02` and `prob03`. If you have questions let your instructor or the lab assistant know. You can also consult your classmates, but please do not copy/paste code.
